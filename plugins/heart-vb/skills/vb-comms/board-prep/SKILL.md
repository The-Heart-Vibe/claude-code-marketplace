---
name: "board-prep"
description: "Przygotowanie na trudne (adversarialne) spotkanie board/IC — numbers cold, antycypacja twardych pytań, narracja która przyznaje słabości nie tracąc sali. Use gdy: 'przygotuj na board', 'przygotuj na IC', 'spotkanie z zarządem', 'board meeting prep', 'jak odpowiedzieć na trudne pytania inwestora', 'investor update narrative', 'rehearsal przed prezentacją'."
---
